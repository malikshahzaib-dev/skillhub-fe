...
const ApplicantSchema = z.object({
  education: z
    .string()
    .min(1, "education should be at least 1 character ")
    .max(20),
...
const ApplicantInformation = () => {
  ...
  const {
   ...
   const handleU = (e: React.ChangeEvent<HTMLInputElement>) => {
...
<NavBar/>
      ...
      <div style={{ background: "#f9f9f5" ,marginTop:"105px"}}>
        <div>
        ...
        <form onSubmit={handleSubmit(createApplicant)}>
          <div className="d-flex justify-content-center">
            ...
            >
              ...
              />
              {errors.address && (
                <p className="tex-danger">{errors.address.message}</p>
              )}
            </div>
          </div>
